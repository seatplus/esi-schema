...
namespace Seatplus\EsiSchema\Resources\Fittings;
...
final class DeleteCharactersCharacterIdFittingsFittingId implements EsiOperationInterface
{
    ...
    public const ?string REQUIRED_SCOPE = 'esi-fittings.write_fittings.v1';

    /** Rate-limit group name (e.g. 'char-asset'). Null when not rate-limited. */
    public const ?string RATE_LIMIT_GROUP = 'fitting';
