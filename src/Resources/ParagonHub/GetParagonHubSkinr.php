...
/**
 * ESI operation: getParagonHubSkinr
 *
 * Generated by bin/generate.php — see Seatplus\EsiSchema\GeneratedSpec::COMPATIBILITY_DATE.
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetParagonHubSkinr implements EsiOperationInterface
{
    ...
    public const ?string RATE_LIMIT_GROUP = 'paragon-hub';
     ...
     */
    public static function execute(EsiTransportInterface $transport, ?string $after = null, ?string $before = null, ?int $limit = null): ParagonHubSkinr
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('GET', '/paragon-hub/skinr', [], ['after' => $after, 'before' => $before, 'limit' => $limit]);
        $dto = ParagonHubSkinr::from((object) $response->data);
