...
/**
 * ESI operation: getCharactersMercenaryTacticalOperationsDetail
 *
 * Generated from ESI OpenAPI spec (compatibility date: 2026-07-17).
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetCharactersMercenaryTacticalOperationsDetail implements EsiOperationInterface
{
