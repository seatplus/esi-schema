...
namespace Seatplus\EsiSchema\Resources\Killmails;
...
final class GetCorporationsCorporationIdKillmailsRecent implements EsiOperationInterface
{
    ...
    public const ?string REQUIRED_SCOPE = 'esi-killmails.read_corporation_killmails.v1';

    /** Rate-limit group name (e.g. 'char-asset'). Null when not rate-limited. */
    public const ?string RATE_LIMIT_GROUP = 'corp-killmail';
