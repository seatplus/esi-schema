...
namespace Seatplus\EsiSchema\Resources\Skills;
...
final class GetCharactersCharacterIdSkills implements EsiOperationInterface
{
    ...
    public const ?string REQUIRED_SCOPE = 'esi-skills.read_skills.v1';

    /** Rate-limit group name (e.g. 'char-asset'). Null when not rate-limited. */
    public const ?string RATE_LIMIT_GROUP = 'char-detail';
