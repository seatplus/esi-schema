...
/**
 * ESI operation: getMilitaryCampaignsListing
 *
 * Generated by bin/generate.php — see Seatplus\EsiSchema\GeneratedSpec::COMPATIBILITY_DATE.
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetMilitaryCampaignsListing implements EsiOperationInterface
{
     ...
     */
    public static function execute(EsiTransportInterface $transport): MilitaryCampaignsListing
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('GET', '/military-campaigns', [], []);
        $dto = MilitaryCampaignsListing::from((object) $response->data);
