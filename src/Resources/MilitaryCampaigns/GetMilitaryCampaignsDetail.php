...
/**
 * ESI operation: getMilitaryCampaignsDetail
 *
 * Generated by bin/generate.php — see Seatplus\EsiSchema\GeneratedSpec::COMPATIBILITY_DATE.
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetMilitaryCampaignsDetail implements EsiOperationInterface
{
     ...
     */
    public static function execute(EsiTransportInterface $transport, string $campaignId): MilitaryCampaignsDetail
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('GET', '/military-campaigns/{campaign_id}', ['campaign_id' => $campaignId], []);
        $dto = MilitaryCampaignsDetail::from((object) $response->data);
