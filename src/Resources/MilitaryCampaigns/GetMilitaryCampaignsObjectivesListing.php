...
/**
 * ESI operation: getMilitaryCampaignsObjectivesListing
 *
 * Generated by bin/generate.php — see Seatplus\EsiSchema\GeneratedSpec::COMPATIBILITY_DATE.
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetMilitaryCampaignsObjectivesListing implements EsiOperationInterface
{
     ...
     */
    public static function execute(EsiTransportInterface $transport, string $campaignId, ?string $after = null, ?string $before = null, ?int $limit = null): MilitaryCampaignsObjectivesListing
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('GET', '/military-campaigns/{campaign_id}/objectives', ['campaign_id' => $campaignId], ['after' => $after, 'before' => $before, 'limit' => $limit]);
        $dto = MilitaryCampaignsObjectivesListing::from((object) $response->data);
