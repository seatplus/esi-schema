...
final class GetCosmeticsSkinr implements EsiOperationInterface
{
    ...
    public const ?string RATE_LIMIT_GROUP = 'skinr';
    ...
    public const ?int CACHE_AGE = 31536000;
     ...
     */
    public static function execute(EsiTransportInterface $transport, string $skinrId): CosmeticsSkinr
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('GET', '/cosmetics/skinr/{skinr_id}', ['skinr_id' => $skinrId], []);
        $dto = CosmeticsSkinr::from((object) $response->data);
