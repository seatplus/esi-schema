...
/**
 * ESI operation: getCharactersCosmeticsSkinr
 *
 * Generated by bin/generate.php — see Seatplus\EsiSchema\GeneratedSpec::COMPATIBILITY_DATE.
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetCharactersCosmeticsSkinr implements EsiOperationInterface
{
     ...
     */
    public static function execute(EsiTransportInterface $transport, int $characterId): CharactersCosmeticsSkinr
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('GET', '/characters/{character_id}/cosmetics/skinr', ['character_id' => $characterId], []);
        $dto = CharactersCosmeticsSkinr::from((object) $response->data);
