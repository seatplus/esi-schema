...
/**
 * ESI operation: getCorporationsStructuresSkyhooksListing
 *
 * Generated from ESI OpenAPI spec (compatibility date: 2026-05-19).
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetCorporationsStructuresSkyhooksListing implements EsiOperationInterface
{
     ...
     */
    public static function execute(EsiTransportInterface $transport, int $corporationId): CorporationsStructuresSkyhooksListing
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('get', '/corporations/{corporation_id}/structures/skyhooks', ['corporation_id' => $corporationId], []);
        $dto = CorporationsStructuresSkyhooksListing::from((object) $response->data);
