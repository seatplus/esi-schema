...
class FittingsResource extends AbstractResource
{
    ...
    {
        $response = $this->transport->invoke('get', '/characters/{character_id}/fittings', ['character_id' => $characterId], 'latest', []);
    ...
    {
        $response = $this->transport->invoke('post', '/characters/{character_id}/fittings', ['character_id' => $characterId], 'latest', [], (array) $requestBody);
    ...
    {
        $response = $this->transport->invoke('delete', '/characters/{character_id}/fittings/{fitting_id}', ['character_id' => $characterId, 'fitting_id' => $fittingId], 'latest', [], []);
        return EsiResult::fromRaw($response, null);
    }
}
