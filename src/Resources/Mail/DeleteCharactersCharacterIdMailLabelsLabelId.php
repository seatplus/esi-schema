...
/**
 * ESI operation: deleteCharactersCharacterIdMailLabelsLabelId
 *
 * Generated from ESI OpenAPI spec (compatibility date: 2026-07-17).
 * Do not edit manually — run bin/generate.php instead.
 */
final class DeleteCharactersCharacterIdMailLabelsLabelId implements EsiOperationInterface
{
    /** Required OAuth2 scope. Null for public endpoints. */
    public const ?string REQUIRED_SCOPE = 'esi-mail.organize_mail.v1';
     ...
     */
    public static function execute(EsiTransportInterface $transport, int $characterId, int $labelId): EsiResult
    {
        $transport->assertScope(self::REQUIRED_SCOPE);
        $response = $transport->invoke('delete', '/characters/{character_id}/mail/labels/{label_id}', ['character_id' => $characterId, 'label_id' => $labelId], [], []);
