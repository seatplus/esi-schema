...
final class GetCharactersCharacterIdNotifications implements EsiOperationInterface
{
    ...
    public const ?string REQUIRED_SCOPE = 'esi-characters.read_notifications.v1';

    /** Rate-limit group name (e.g. 'char-asset'). Null when not rate-limited. */
    public const ?string RATE_LIMIT_GROUP = 'char-notification';

    /** Maximum token bucket size for this rate-limit group. */
    public const ?int RATE_LIMIT_MAX_TOKENS = 15;
