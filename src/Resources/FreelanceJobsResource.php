...
class FreelanceJobsResource extends AbstractResource
{
    ...
    {
        $response = $this->transport->invoke('get', '/characters/{character_id}/freelance-jobs', ['character_id' => $characterId], 'latest', []);
    ...
    {
        $response = $this->transport->invoke('get', '/characters/{character_id}/freelance-jobs/{job_id}/participation', ['character_id' => $characterId, 'job_id' => $jobId], 'latest', []);
    ...
    {
        $response = $this->transport->invoke('get', '/corporations/{corporation_id}/freelance-jobs', ['corporation_id' => $corporationId], 'latest', ['after' => $after, 'before' => $before, 'limit' => $limit]);
    ...
    {
        $response = $this->transport->invoke('get', '/corporations/{corporation_id}/freelance-jobs/{job_id}/participants', ['corporation_id' => $corporationId, 'job_id' => $jobId], 'latest', ['after' => $after, 'before' => $before, 'limit' => $limit]);
    ...
    {
        $response = $this->transport->invoke('get', '/freelance-jobs', [], 'latest', ['after' => $after, 'before' => $before, 'limit' => $limit, 'corporation_id' => $corporationId]);
    ...
    {
        $response = $this->transport->invoke('get', '/freelance-jobs/{job_id}', ['job_id' => $jobId], 'latest', []);
