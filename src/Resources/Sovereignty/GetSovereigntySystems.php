...
namespace Seatplus\EsiSchema\Resources\Sovereignty;
...
/**
 * ESI operation: getSovereigntySystems
 *
 * Generated from ESI OpenAPI spec (compatibility date: 2026-06-09).
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetSovereigntySystems implements EsiOperationInterface
{
    ...
    public const ?string RATE_LIMIT_GROUP = 'sovereignty';
