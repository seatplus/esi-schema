...
namespace Seatplus\EsiSchema\Resources\Alliance;
...
/**
 * ESI operation: getAlliances
 *
 * Generated from ESI OpenAPI spec (compatibility date: 2026-07-21).
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetAlliances implements EsiOperationInterface
{
    ...
    public static function execute(EsiTransportInterface $transport): EsiResult
    {
        ...
        $response = $transport->invoke('get', '/alliances', [], []);
        /** @var array<int> $data */
