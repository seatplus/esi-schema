...
class MetaResource extends AbstractResource
{
    ...
    public function getMetaChangelog(): MetaChangelog
    {
        ...
        $dto->operationMeta = static::OPERATION_META['getMetaChangelog'] ?? null;
        return $dto;
    }
    ...
    public function getMetaCompatibilityDates(): MetaCompatibilityDates
    {
        ...
        $dto->isCachedLoad = $response->isCachedLoad;
        $dto->pages = $response->pages;
        $dto->operationMeta = static::OPERATION_META['getMetaCompatibilityDates'] ?? null;
        return $dto;
    }
    ...
    public function getMetaStatus(): MetaStatus
    {
        ...
        $dto->isCachedLoad = $response->isCachedLoad;
        $dto->pages = $response->pages;
        $dto->operationMeta = static::OPERATION_META['getMetaStatus'] ?? null;
        return $dto;
    }
}
