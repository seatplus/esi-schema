...
namespace Seatplus\EsiSchema\Operations\Loyalty;
...
final class GetCharactersCharacterIdLoyaltyPoints implements EsiOperationInterface
{
    ...
    public const ?string REQUIRED_SCOPE = 'esi-characters.read_loyalty.v1';

    /** Rate-limit group name (e.g. 'char-asset'). Null when not rate-limited. */
    public const ?string RATE_LIMIT_GROUP = 'char-wallet';
