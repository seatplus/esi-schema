...
/**
 * ESI operation: getUniverseConstellations
 *
 * Generated from ESI OpenAPI spec (compatibility date: 2025-12-16).
 * Do not edit manually — run bin/generate.php instead.
 */
final class GetUniverseConstellations implements EsiOperationInterface
{
    ...
    {
        $response = $transport->invoke('get', '/universe/constellations', [], []);
        /** @var array<int> $data */
