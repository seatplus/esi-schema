...
final class GetCorporationsProjectsContributors implements EsiOperationInterface
{
    ...
    private const array META = ['cacheAge' => 0, 'rateLimit' => ['group' => 'corp-project', 'max-tokens' => 600, 'window-size' => '15m'], 'requiredRoles' => ['Project_Manager'], 'cursor' => true, 'requiredScope' => 'esi-corporations.read_projects.v1'];
